...
function createFeatures(data) {
  ...
  forEach(d => ) -> L.marker([d.lat, d.long]).bindPopup};

// function createFeatures(mlbStadium) {
//   L.marker([mlbStadium.lat, mlbStadium.long],{
//   title: "MLB Teams"
//   }).bindPopup('Hello')
//   // forEach(d => ) -> L.marker([d.lat, d.long]).bindPopup
  

  // var baseballStadium = L.geoJSON(mlbStadium, {
  // // Define a function we want to run once for each feature in the features array
  // // Give each feature a popup describing the place and time of the earthquake
  //  onEachFeature: function(feature, layer) {
  //   layer.bindPopup("<h3>" + data.team + data.lat + data.long
  //     + "</p>");
  // }

  // Create a GeoJSON layer containing the features array on the MLB Stadium object
  ...
  // Sending our stadium layer to the createMap function
  createMap(mlbStadium);
// }

function createMap(mlbStadium) {
