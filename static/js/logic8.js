  ...
  //   var queryUrl = "https://api.myjson.com/bins/1103sp";
  ...
  createFeatures(beerdata);
    ...
    var brewery = L.layerGroup(markerListbrewery);
...
var mlbStadiums = L.layerGroup(markerList);
    ...
    function myFunction() {
      ...
      var map = L.map("map", {
        center: [39.82, -98.57],
        zoom: 5.2,
        layers: [lightmap, streetmap, darkmap, brewery, mlbStadiums]
      });
